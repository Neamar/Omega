...
var Editor = (function(){
  ...
  function Editor(options) {
    ...
    if (!options.readOnly) {
      ...
      /**CUSTOM:Added focus and click callback**/
      addEventHandler(document, "focus", options.focusCallback);
      addEventHandler(document, "click", options.clickCallback);
      /*********************************************************/
  ...
  Editor.prototype = {
    ...
    keyDown: function(event) {
      ...
      if (code == 13) { // enter
        ...
        else if (this.options.controlFunction) {
