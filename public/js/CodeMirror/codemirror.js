...
var CodeMirror = (function(){
  ...
  function addLineNumberDiv(container) {
    ...
    /**CUSTOM:Added zIndex and left style values**/
    nums.style.left = '0px';
    /*******************************************/
  ...
  function CodeMirror(place, options) {
    ...
    /**CUSTOM:Added UTF-8 content-type meta header**/
  ...
  CodeMirror.prototype = {
    ...
    setLineNumbers: function(on) {
      if (on && !this.lineNumbers) {
        ...
        /**CUSTOM:Removed marginLeft and added paddingLeft**/
        //this.wrapping.style.marginLeft = "";
        this.win.document.body.style.paddingLeft = '0px';
        /***************************************************/
    ...
    activateLineNumbers: function() {
      ...
      function sizeBar() {
        ...
        if (nums.offsetWidth != barWidth) {
          ...
          /**CUSTOM:Replaced left value with padding**/
          //nums.style.left = "-" + (frame.parentNode.style.marginLeft = barWidth + "px");
          win.document.body.style.paddingLeft = barWidth + 4 + 'px';
          nums.style.left = '0px';
          /*******************************************/
        }
      }
