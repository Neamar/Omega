...
CREATE TABLE IF NOT EXISTS `work`.`Blog_Articles` (
...
(1, 'Banque', NULL, 10000, '2011-01-22 12:00:00', '2011-01-22 12:00:00', 'OK', 'ADMINISTRATEUR'),
(2, 'matthieu@bacconnier.fr', 'd6b00dfd8ad4a71bc5cfb776ed60f99c2f94490b', 0, '2011-03-05 14:16:53', '2011-03-05 14:16:53', 'OK', 'CORRECTEUR'),
(3, 'webmaster@edevoir.com', 'b7f1ddaa98d1000b4bfdecb869a72378d539fc3f', 0, '2011-03-05 14:18:13', '2011-03-05 14:18:13', 'OK', 'ADMINISTRATEUR'),
(4, 'anthony.tschirhard@gmail.com', '0d108970e9d532f05ad5cdf5392ef98fceab7a65', 0, '2011-03-05 14:29:48', '2011-03-05 14:29:48', 'OK', 'CORRECTEUR'),
(5, 'contact@edevoir.com', '010a05e6f6da2250a82465738f8053bd631eb417', 0, '2011-03-05 14:20:46', '2011-03-05 14:20:46', 'OK', 'ADMINISTRATEUR');

INSERT INTO `Correcteurs` (`ID`, `Prenom`, `Nom`, `Telephone`, `Siret`, `SiretOK`) VALUES
(2, 'Matthieu', 'Bacconnier', '0669347015', '52823743100010', '1'),
(4, 'Anthony', 'Tschirhard', '0681903164', NULL, '0');

INSERT INTO `Administrateurs` (`ID`) VALUES (3);
INSERT INTO `Administrateurs` (`ID`) VALUES (5);
