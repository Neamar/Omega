...
{
	$Retour['left'] = '<strong class="pts">' . number_format($_SESSION['Eleve']->getPoints(), 0, ',', ' ') . ' pts</strong>. <a href="/eleve/points/ajout">Ajouter des points</a>';
	$Retour['right'] = '<a href="/eleve/">' . $_SESSION['Eleve']->Mail . '</a><a href="/eleve/connexion" class="deconnexion" title="Déconnexion"><img src="/public/images/global/deconnexion.png" alt="Déconnexion" /></a>';
