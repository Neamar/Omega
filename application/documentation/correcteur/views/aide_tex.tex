...
\begin{verbatim}
\includegraphics[options]{Fchier}
\end{verbatim}
...
Pour savoir comment ajouter des ressources à votre correction, merci de \doc[correcteur/aide_ressource.tex]{visiter cette page}.
...
Pour voir des exemples d'environnements mathématiques, merci de \doc[index/tex.phtml]{visiter cette page}.