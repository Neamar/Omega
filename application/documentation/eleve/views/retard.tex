...
Afin de nous faire pardonner ce manque de professionnalisme, vous recevrez en dédommagement pour le préjudice un remboursement à %POURCENTAGE_RETARD%% de la somme payée. Afin d’éviter tout abus, la somme gagnée (au delà des 100% initiaux donc) sera majorée par %MAX_REMBOURSEMENT%€. Le remboursement se fait en points sur votre compte selon l’équivalence standard 1€ = %EQUIVALENCE_POINT%.
...
\item Un exercice (énorme ! Des pages et des pages !) payé 150€ vous sera remboursé 150€ + %MAX_REMBOURSEMENT%€.
