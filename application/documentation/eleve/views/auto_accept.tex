...
\item Toute offre qui vous sera faite de coût supérieur à cette valeur sera automatiquement refusée (dans la limite des %MAX_REFUS% refus, voir les \doc[eleve/refus]{informations sur les refus}).
